    ...
    return (
        <div className="relative min-h-[calc(100vh-80px)] bg-black py-12 px-4 overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-20">
                ...
                <section className="relative z-30 bg-white/8 ring-1 ring-white/10 rounded-2xl p-5 md:p-7 hover:ring-white/20 transition">
                    <div className="grid gap-8 md:grid-cols-2">
                        ...
                        <section className="bg-white/8 ring-1 ring-white/10 rounded-2xl p-5 md:p-7 hover:ring-white/20 transition z-10">
